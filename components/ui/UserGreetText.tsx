...
const UserGreetText = () => {
  ...
  if (userData !== null) {
    ...
    return (
      <div>
        <p
          className="fixed left-0 top-24 w-full flex justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-6 
  ...
  return (
    <p
      className="fixed left-0 top-20 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl 
